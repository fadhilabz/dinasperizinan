...
function TambahSuratMasukContent() {
    ...
    async function loadData() {
      ...
      try {
        ...
        if (!snapshot.exists()) {
          ...
          router.push("/admin/surat-masuk/daftar");
          return;
        }
          ...
          <div className="grid gap-5 md:grid-cols-2">
            ...
            <div>
              ...
              <input
                ...
                placeholder="Contoh: 001/SM/IX/2026"
